...
from flask_mvc.command.exceptions import (
...
"""
    ...
    @patch("flask_mvc.command.controller.generator.CLIConfig.get_templates_dir")
    ...
    @patch("flask_mvc.command.controller.generator.CLIConfig.get_controllers_path")
